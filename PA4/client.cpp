...
void worker_thread_function(BoundedBuffer& reqbuf, BoundedBuffer& resbuf, FIFORequestChannel& chan, string filename){
	/*
		--has two behaviors--
...
int main(int argc, char *argv[]){
	...
	string filename = "";		// default filename empty string used as condition for deciding if its a file request or data request
